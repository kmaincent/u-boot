...
#define JAILHOUSE_ENV \
	"jh_mmcboot=" \
		"setenv fdt_file imx8qxp-cgtsx8x-root.dtb;"\
...
#define XEN_BOOT_ENV \
	    ...
	    "dom0fdt_file=imx8qxp-cgtsx8x-dom0.dtb\0" \
            "xenboot_common=" \
...
#ifdef CONFIG_CGT_ENV_IS_IN_MMC_AUTOADAPT
#define MMCAUTODETECT_ENV	"mmcautodetect=yes\0"
#else
#define MMCAUTODETECT_ENV	""
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"boot_fdt=try\0" \
	"fdt_file=imx8qxp-cgtsx8x.dtb\\0" \
...
#if defined CONFIG_CGT_SX8X_MEM_VAR_4GB
#define PHYS_SDRAM_1_SIZE		0x80000000	/* 2 GB */
#define PHYS_SDRAM_2_SIZE		0x80000000	/* 2 GB */
#elif defined CONFIG_CGT_SX8X_MEM_VAR_2GB
#define PHYS_SDRAM_1_SIZE		0x80000000	/* 2 GB */
#define PHYS_SDRAM_2_SIZE		0x00000000	/* n.a. */
#elif defined CONFIG_CGT_SX8X_MEM_VAR_1GB
#define PHYS_SDRAM_1_SIZE		0x40000000	/* 1 GB */
#define PHYS_SDRAM_2_SIZE		0x00000000	/* n.a. */
#elif defined CONFIG_CGT_SX8X_MEM_VAR_3GB_LEGACY
#define PHYS_SDRAM_1_SIZE		0x80000000	/* 2 GB */
/* LPDDR4 board total DDR is 3GB */
#define PHYS_SDRAM_2_SIZE		0x40000000	/* 1 GB */
#else
#error "no memory variant set!"
#endif
...
#define IMX_FEC0_PD_NAME		"conn_enet0"
#define IMX_FEC0_ENET_DEV               0
#define IMX_FEC0_MXC_PHYADDR            0x4
#define IMX_FEC0_BASE			0x5B040000
#endif /* CONFIG_CGT_ENABLE_FEC0 */

#ifdef CONFIG_CGT_ENABLE_FEC1
#define IMX_FEC1_PD_NAME		"conn_enet1"
#define IMX_FEC1_ENET_DEV               1
#define IMX_FEC1_MXC_PHYADDR            0x5
